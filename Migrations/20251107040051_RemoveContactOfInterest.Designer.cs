...
namespace StudentPortfolio.Migrations
{
    ...
    [Migration("20251107040051_RemoveContactOfInterest")]
    partial class RemoveContactOfInterest
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StudentPortfolio.Models.Competency", b =>
                {
                    ...
                    b.Property<string>("CompetencyDisplayId")
                        .HasMaxLength(50)
                    ...
                    b.HasIndex(new[] { "CompetencyId" }, "UQ_Competency_Id")
                        .IsUnique();
            ...
            modelBuilder.Entity("StudentPortfolio.Models.CompetencyTracker", b =>
                {
                    ...
                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<long>("CompetencyTrackerId"));
                    ...
                    b.HasIndex(new[] { "CompetencyTrackerId" }, "UQ_CompetencyTracker_Id")
                        .IsUnique();
            ...
            modelBuilder.Entity("StudentPortfolio.Models.Level", b =>
                {
                    b.Property<long>("LevelId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.HasIndex(new[] { "LevelId" }, "UQ_Level_levelId")
                        .IsUnique();
