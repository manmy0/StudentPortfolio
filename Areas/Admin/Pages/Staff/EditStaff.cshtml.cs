...
namespace StudentPortfolio.Areas.Admin.Pages.Staff
{
    ...
    public class EditStaffModel : PageModel
    {
        ...
        public EditStaffModel(UserManager<ApplicationUser> userManager)
        {
        ...
        public async Task<IActionResult> OnGetAsync()
        {
            ...
            // Adds the user's information to the StaffInputModel
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            return RedirectToPage("/Staff/Staff");
        }
    }

    // StaffInputModel is only used in this class, so it is here
